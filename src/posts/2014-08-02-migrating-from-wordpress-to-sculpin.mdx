export const metadata = {
  ...
  tags: ['wordpress', 'sculpin', 'blog', 'blogging', 'symfony', 'composer'],
  categories: ['php', 'zf'],
};
...
<span className="text-muted">For more information about how to use Sculpin, it has a very good [documentation](https://sculpin.io/getstarted/).</span>
