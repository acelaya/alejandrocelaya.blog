export const metadata = {
  ...
  tags: ['zf2', 'zend-framework-2', 'zf2-component', 'dependency-injection', 'dependency-injection-container', 'di', 'dic', 'inversion-of-control', 'service-manager'],
  categories: ['zf', 'php', 'tools'],
};
