...
- [How to properly use the Zend framework 2 service manager as a dependency injection container](https://alejandrocelaya.blog/2014/07/03/how-to-properly-use-the-zend-framework-2-service-manager-as-a-dependency-injection-container/)
- [Advanced usage of ServiceManager in Zend Framework 2](https://alejandrocelaya.blog/2014/10/09/advanced-usage-of-service-manager-in-zend-framework-2/)
- [Managing objects creation and dependency injection with Zend\ServiceManager](https://alejandrocelaya.blog/2015/02/06/managing-objects-creation-and-dependency-injection-with-zend-service-manager/)
