...
tags: ['zf2', 'zend-framework-2', 'dependency-injection', 'dependency-injection-container', 'di', 'dic', 'service-manager', 'zf']
categories: ['php']
---
...
<span className="text-muted">For more information about the service manager configuration read [this](https://framework.zend.com/manual/2.3/en/modules/zend.service-manager.quick-start.html).</span>
