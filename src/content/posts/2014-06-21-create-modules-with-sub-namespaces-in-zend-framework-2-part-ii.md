...
Some weeks ago, I explained how to create [modules with sub-namespaces](https://alejandrocelaya.blog/2014/05/21/create-modules-with-sub-namespaces-in-zend-framework-2/) in a Zend Framework 2 application.
