...
tags: ['composer', 'building', 'dependency-management', 'continuous-integration']
...
> If you are not familiar with composer, some time ago I wrote an introduction article that you should read before continuing with this one. [Dependency management and autoloading in php projects with composer](/2014/07/19/dependency-management-and-autoloading-in-php-projects-with-composer/).
