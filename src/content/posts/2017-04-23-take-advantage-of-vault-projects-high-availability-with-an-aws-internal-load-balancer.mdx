...
![Load balancer](/assets/img/vault-with-load-balancer/balancer-first-step.png)

Then, when you are asked to configure the health check, use this params.

![Health check](/assets/img/vault-with-load-balancer/health-check.png)
...
![Instances status](/assets/img/vault-with-load-balancer/instances-status.png)
