...
tags: ['database', 'uuid', 'doctrine', 'security']
categories: ['php']
---
...
* Decouples your application with the persistence layer, since all the information is generated before being persisted.
