...
Resolving template paths is not immediate in sub-namespaced modules. It was first said [here](/2014/06/21/create-modules-with-sub-namespaces-in-zend-framework-2-part-ii/#comment-391).
