...
export const metadata = {
  ...
  tags: ['zend-expressive', 'microframework', 'error-handling', 'content-negotiation', 'zf3'],
  categories: ['php', 'zf'],
};
...
<TweetEmbed tweetId="757889412252307456" client:only="react" />
...
<TweetEmbed tweetId="757884384196386816" client:only="react" />
